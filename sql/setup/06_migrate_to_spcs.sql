...
-- (Replace with actual app name if different)
-- DESCRIBE STREAMLIT TCH_PATIENT_360_APP;
...
ALTER STREAMLIT TCH_PATIENT_360_APP
...
-- ALTER STREAMLIT TCH_PATIENT_360_APP SET RUNTIME_NAME = 'SYSTEM$WAREHOUSE_RUNTIME';
--
-- Common issues:
